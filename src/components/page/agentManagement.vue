            ...
            <el-form ref="editForm" :model="editForm" label-width="100px" :rules="carFormRules">
                ...
                <el-form-item label="状态" prop="state">
                    <el-select v-model="editForm.state" placeholder="状态" class="handle-select mr10">
                        ...
                        <el-option key="3" label="即将过期" value="3"></el-option>
                    </el-select>
                </el-form-item>
            ...
            return {
                ...
                carFormRules:{
                    username:[
                        ...
                        {min: 3, max: 12, message: '请输入正确姓名', trigger: 'blur'}
                    ],
                    phoneNumber:[
                        {message:'手机号不能为空',required:true,trigger: 'blur'},
                        {min: 8, max: 11, message: '长度应在8个字到11个字之间', trigger: 'blur'}
                    ],
                    site:[
                        {message:'地点不能为空',required:true,trigger: 'blur'},
                    ]
                },
                idx: -1,
                id: -1
